...
(function (Da, P, l) {
  var O = function (g) {
    ...
    function G(a, b, c) {
      ...
      g.each(b, function (d) {
        e = a._hungarianMap[d];
        if (e !== l && (c || b[e] === l)) 'o' === e.charAt(0) ? (b[e] || (b[e] = {
        }), g.extend(!0, b[e], b[d]), G(a[e], b[e], c))  : b[e] = b[d]
      })
    }
    function O(a) {
    ...
    function ja(a, b, c) {
      ...
      c !== l && null !== c && (eb(c), G(p.defaults.column, c), c.mDataProp !== l && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), g.extend(b, c), D(b, c, 'sWidth', 'sWidthOrig'), 'number' === typeof c.iDataSort && (b.aDataSort = [
        c.iDataSort
      ]), D(b, c, 'aDataSort'));
      var h = b.mData,
      i = W(h),
    ...
    function Ga(a) {
      ...
      k;
      d = 0;
      for (f = b.length; d < f; d++) if (m = b[d], k = [
      ], !m.sType && m._sManualType) m.sType = m._sManualType;
       else if (!m.sType) {
        h = 0;
    ...
    function I(a, b, c, e) {
      ...
      f._aData = b;
      a.aoData.push(f);
      for (var b = a.aoColumns, f = 0, h = b.length; f < h; f++) c && Ha(a, d, f, v(a, d, f)),
      b[f].sType = null;
    ...
    function L(a) {
      var b = u(a, 'aoPreDrawCallback', 'preDraw', [
        a
      ]);
    ...
    function lb(a) {
      ...
      for (var f = a.sDom.split(''), h, i, j, n, m, o, k = 0; k < f.length; k++) {
        ...
        h && (j = a.aanFeatures, j[i] || (j[i] = [
        ]), j[i].push(h), d.append(h))
      }
      c.replaceWith(d)
    }
    function da(a, b) {
    ...
    function qa(a, b, c) {
      u(a, 'aoServerParams', 'serverParams', [
        b
      ]);
      if (b && g.isArray(b)) {
        var e = {
    ...
    function vb(a, b, c, e, d, f) {
      if ('' !== b) for (var h = a.aiDisplay, e = Pa(b, e, d, f), d = h.length - 1; 0 <= d; d--) b = a.aoData[h[d]]._aFilterData[c],
    ...
    function Fb(a, b) {
      for (var c, e = - 1, d = - 1, f = 0, h = a.aoData.length; f < h; f++) c = v(a, f, b, 'display') + '',
      c = c.replace(Zb, ''),
    ...
    function Ta(a, b, c, e) {
      ...
      'number' === typeof d[0] && (d = a.aaSorting = [
        d
      ]);
      c && a.oFeatures.bSortMulti ? (c = g.inArray(b, C(d, '0')), - 1 !== c ? (b = h(d[c], !0), null === b ? d.splice(c, 1)  : (d[c][1] = f[b], d[c]._idx = b))  : (d.push([b,
      f[0],
      0]), d[d.length - 1]._idx = 0))  : d.length && d[0][0] == b ? (b = h(d[0]), d.length = 1, d[0][1] = f[b], d[0]._idx = b)  : (d.length = 0, d.push([b,
      f[0]]), d[0]._idx = 0);
      M(a);
    ...
    function Hb(a, b) {
      ...
      j; g++) if (c = a.aoData[g], c._aSortData || (c._aSortData = [
      ]), !c._aSortData[b] || e) f = e ? d[g] : v(a, g, b, 'sort'),
    ...
    function Jb(a) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (d && d.time && (b = u(a, 'aoStateLoadParams', 'stateLoadParams', [
          a,
          d
        ]), - 1 === g.inArray(!1, b) && (b = a.iStateDuration, !(0 < b && d.time < + new Date - 1000 * b) && e.length === d.columns.length))) {
    ...
    function Kb(a, b, c) {
      var e,
      d;
      for (d in b) b.hasOwnProperty(d) && (e = b[d], g.isPlainObject(e) ? (g.isPlainObject(a[d]) || (a[d] = {
    ...
    Rb = function (a) {
      for (var b = [
      ], c = 0, e = a.length; c < e; c++) a[c] && b.push(a[c]);
      return b
    },
    Ma = function (a) {
      var b = [
    ...
    p = function (a) {
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase()) R(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
          ...
          null === d.asStripeClasses && (k.asStripeClasses = [
            j.sStripeOdd,
            j.sStripeEven
          ]);
    ...
    var Za = function (a, b) {
      ...
      j;
      e = typeof a;
      if (!a || 'string' === e || 'function' === e || a.length === l) a = [
        a
      ];
      f = 0;
      for (h = a.length; f < h; f++) {
        d = a[f] && a[f].split ? a[f].split(',')  : [
          a[f]
        ];
        i = 0;
    ...
    r('rows.add()', function (a) {
      var b = this.iterator('table', function (b) {
        ...
        c.nodeName && 'TR' === c.nodeName.toUpperCase() ? g.push(la(b, c) [0])  :
        g.push(I(b, c));
        return g
      }, 1),
      c = this.rows( - 1);
    ...
    Vb = function (a, b, c, e, d) {
      for (var c = [
      ], e = 0, f = d.length; e < f; e++) c.push(v(a, d[e], b));
      return c
    };
    ...
    p.camelToHungarian = G; r('$()', function (a, b) {
    ...
    'off'], function (a, b) {
      ...
      oLanguage: {
        ...
        sInfoFiltered: '(filtered de _MAX_ total Registros)',
        sInfoPostFix: '',
        sDecimal: '',
        sThousands: ',',
    ...
    }); var Lb = p.ext.pager; g.extend(Lb, {
      simple: function () {
        return ['previous',
        'next']
      },
  ...
  g.fn.dataTable = p; g.fn.dataTableSettings = p.settings; g.fn.dataTableExt = p.ext; g.fn.DataTable = function (a) {
