...
use Mike42\Escpos\EscposImage\EscposImage;
...
$items = array(new item("Example item #1dfd df df df df df df df df df df dfd fdf dfd", "4.00"), new item("Another thing", "3.50"), new item("Something else", "1.00"), new item("A final item", "4.45"));
