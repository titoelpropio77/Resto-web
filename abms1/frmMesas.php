...
include "modal/modalMesas.php";
  ...
  <li class="active"><a href="#" ><b>MESAS</b></a></li>
  <li ><a href="frmUsuario.php" ><b>USUARIO</b></a></li>
  <li ><a href="frmEmpresa.php" ><b>EMPRESA</b></a></li>
</ul>
</div>
      <div class="panel-body">
     <button type="button" class="btn btn-success " data-toggle="modal" data-target="#modalMesa">NUEVA MESA</button>
     <button onclick="window.open('edicionDirecta/edicionDIrectaMesa.php');" type="button" class="btn btn-warning pull-right" >EDICION DIRECTA</button>
...
<table id="tablaMesa" class="table table-bordered table-hover table-responsive table-condensed dataTable" > <!--jquery.dataTables.min.js -->
     <thead style="text-align: left;">
          <tr>
               <th style="    padding-left: 0;">CODIGO</th>
               <th style="padding-left: 0; ">COLORES</th>
               <th style="    padding-left: 0;">NOMBRE MESA</th>
