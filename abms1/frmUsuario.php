...
include "modal/modalUsuario.php";
  ...
  <li class="active"><a href="#" ><b>USUARIO</b></a></li>
...
<table id="tablaUsuario" class="table table-bordered table-hover table-responsive table-condensed dataTable" > <!--jquery.dataTables.min.js -->
     <thead style="text-align: left;">
          <tr>
               <th style="    padding-left: 0;">COD</th>
               <th style="padding-left: 0; ">NOMBRE</th>
               <th style="    padding-left: 0;">CARGO</th>
               <th style="    padding-left: 0;">LOGIN</th>
               <th style="    padding-left: 0;">ESTADO</th>
